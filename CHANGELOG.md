...
<details>
<summary> Update layers/meta-balena to f257dbef1e45f7b296c2be51418fddb6c26e5a22 [Renovate Bot] </summary>
...
<details>
<summary> Update layers/meta-balena to ecfd582cea1f2ca7a5e282424693487320b5ce85 [Renovate Bot] </summary>
...
* Moce renovate.json to repository root and add includeForks [Alex Gonzalez]
* Remove fork configuration that exists on parent from local renovate configuration [Alex Gonzalez]
* Configure renovate to work on fork [Alex Gonzalez]
* Add contracts submodule [Alex Gonzalez]
* Add renovate configuration [Alex Gonzalez]

<details>
<summary> Update balena-yocto-scripts to v1.19.8 [Florin Sarbu] </summary>
...
* Update to honister [Francois Loubser]
* Add build and deploy workflow [Alex Gonzalez]
* layers/meta-balena: Add submodule on v2.98.12 [Alexandru Costache]
